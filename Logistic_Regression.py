...
# ROC AUC
# farklı threshold lara göre oluşabilecek başarı hesaplanması
...
# hold-out yönteminde gözlem sayısı az olduğundan ve random state her değiştiğinde
# accuracy recall gibi değerler değişiklik göstermekte
# bu da bize CV yöntemini kullanmamız gerektiğini gösteriyor
# genel alışkanlığımız k katlı olmalı
...
# cv yöntemiyle yukarıda hesaplanan değerlerle hatayı değerlendiririz
